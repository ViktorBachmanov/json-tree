...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        const radioImage = document.querySelector('input[value="{{ $IMG }}"]');
        const radioColor = document.querySelector('input[value="{{ $RGB }}"]');
        const inputImage = document.querySelector('input[name="{{ $IMG }}"]');
        const inputColor = document.querySelector('input[name="{{ $RGB }}"]');
